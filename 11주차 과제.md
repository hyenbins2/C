...
```.c
printf("12.0의 절대값은 %f\n", fabs(12.0));
// 12.0의 절댓값을 구하기 위해 fabs 함수를 사용하여 12.0의 절댓값을 계산하고,
// 그 결과를 소수점 형식으로 출력합니다. 출력 결과는 "12.0의 절대값은 12.000000"이 됩니다.
...
// 10의 3승은 1000이므로 출력 결과는 "10의 3승은 1000."이 됩니다.

printf("16의 제곱근은 %.0f.\n", sqrt(64));
// sqrt 함수를 사용하여 64의 제곱근을 계산하고, 그 결과를 정수 형식으로 출력합니다.
// 64의 제곱근은 8이므로 출력 결과는 "16의 제곱근은 8."이 됩니다.
```
출력 : 
```
10의 3승은 1000.
